...
<div class="rbt-style-guide-area rbt-utilize-area rainbow-section-gap-big">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-3">
                <div class="rbt-default-sidebar sticky-top rbt-shadow-box rbt-gradient-border-2">
                    <div class="inner">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="b3">B3- Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                    Similique non ipsam reiciendis.</p>
                                <p>Befault- Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique
                                    non
                                    ipsam reiciendis.</p>
                            </div>
                        </div>
                        ...
                        <div class="row g-5 align-items-center">
                            <div class="col-lg-2">
                                <div class="rbt-avatars m-auto size-lg">
                                    <img src="{{ asset('assets/images/team/team-01.png') }}" alt="Author Images">
                                </div>
                            </div>
                            <div class="col-lg-2">
                ...
                <div id="animatedHeading" class="rbt-elements-area rbt-shadow-box">
                    <div class="wrapper">
                        <div class="section-title">
