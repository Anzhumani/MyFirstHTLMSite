<!-- Start Header Area  -->
<header class="rainbow-header header-default header-not-transparent header-left-align rbt-fluid-header">
            ...
            <div class="col-lg-9 col-md-6 col-6 position-static">
                <div class="header-right">
                    ...
                    <div class="header-btn">
                        <a class="btn-default btn-small round" target="_blank" href="{{ asset('textgenerator') }}">Get Started Free</a>
                    </div>
                    <!-- End Header Btn  -->
