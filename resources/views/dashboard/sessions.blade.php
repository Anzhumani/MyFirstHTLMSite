                        ...
                        <div class="list-card-grp">
                                ...
                                <div class="inner">
                                    <div class="left-content">
                                        <div class="img-section">
                                            <img src="{{ asset('assets/images/sign-up/firefox.png') }}" alt="Browser Icon">
                                        </div>
                            ...
                            <div class="list-card">
                                <div class="inner">
                                    <div class="left-content">
                                        <div class="img-section">
                                            <img src="{{ asset('assets/images/sign-up/chrome.png') }}" alt="Browser Icon">
                                        </div>
                                        <div class="content-section">
                            ...
                            <div class="btn-group mt--20">
                                <a class="btn-default" href="#"><i class="feather-log-out"></i> Sign out All devices</a>
                            </div>
                        </div>
                    </div>
                </div>
